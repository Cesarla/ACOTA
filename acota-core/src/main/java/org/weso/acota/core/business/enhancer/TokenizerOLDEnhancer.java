 ...
 * 
 */
public class TokenizerOLDEnhancer extends EnhancerAdapter implements
		Configurable {

	protected static final String[] nplTokensEs = new String[] { "NC", "NP",
			"VA", "VIP", "VM", "VS", "W", "Z", "ZM", "ZP", "AO", "AQ" };
	...
	/**
	 * Inner Class StringArrayWrapper is a wrap of a String[], so it could be
	 * used as key in Maps or similar data structures.
	 * 
	 * @author César Luis Alvargonzález
	 * 
	 */
	 ...
	 *             object
	 * @throws IOException
	 *             If there is some issue reading OpenNLP's files
	 */
	public TokenizerOLDEnhancer() throws AcotaConfigurationException,
			IOException {
		super();
	...
	/**
	 * Tokenizes and removes stop-words (Spanish and English) from the supplied
	 * text
	 * 
	 * @param title
	 ...
	 * @param relevance
	 *            Weight which is incremented each matched term
	 * @throws IOException
	 *             Signals that an I/O exception of some sort has occurred
	 */
	...
	/**
	 * Adds or Increases (If currently exists) the label to the auxiliary labels
	 * map
	 * 
	 * @param label
	 *            Label's name
	...
	/**
	 * Trims the labels removing non meaningful words from the edges of the
	 * sentence
	 * 
	 * @param tags
	 *            OpenNLP Tags related to the Tokenized Text
	 * @param tokenizedText
	 *            Tokenized Text
	 * @param relevance
	 *            Weight which is incremented each matched term
	...
	public void loadConfiguration(CoreConfiguration configuration)
		...
		this.tokenizerRelevanceLabel = configuration
				.getTokenizerLabelRelevance();
